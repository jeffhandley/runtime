...
Write down your independent assessment before proceeding. You must produce a holistic assessment (per the criteria in `.github/instructions/review-general.instructions.md`) at this stage.
...
- **Always:** `review-general.instructions.md` -- reviewer mindset, the Holistic PR Assessment criteria (Motivation, Evidence, Approach, Cost-Benefit, Scope, Risk, Codebase Fit), correctness philosophy, PR hygiene, consistency, and documentation. Use these criteria to write the Holistic Assessment in your output.
...
- **Test files (`**/tests/**`, `src/tests/**`) changed:** `review-tests.instructions.md` -- testing conventions and regression-test requirements.
